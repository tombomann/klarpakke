-- Reset schema: Drop and recreate all tables cleanly
-- Use this if you have schema conflicts from previous migrations
...
-- ============================================
-- POSITIONS: Åpne og lukkete trading posisjoner
-- ============================================
